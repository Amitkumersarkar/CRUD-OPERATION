...
async function run() {
    try {
        ...
        const database = client.db("usersDatabase"); // Replace "myDatabase" with your database name
        const userCollection = database.collection("users"); // Replace "myCollection" with your collection name

        //declared post for backend
